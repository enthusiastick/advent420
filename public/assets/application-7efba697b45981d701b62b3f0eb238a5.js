...
(function() {
  TextileEditor.setButtons([new TextileEditorButton("ed_strong", "/assets/textile-editor/bold.png", "*", "*", "b", "Bold", "s"), new TextileEditorButton("ed_emphasis", "/assets/textile-editor/italic.png", "_", "_", "i", "Italicize", "s"), new TextileEditorButton("ed_underline", "/assets/textile-editor/underline.png", "+", "+", "u", "Underline", "s"), new TextileEditorButton("ed_strike", "/assets/textile-editor/strikethrough.png", "-", "-", "s", "Strikethrough", "s"), new TextileEditorButton("ed_ol", "/assets/textile-editor/list_numbers.png", " # ", "\n", ",", "Numbered List"), new TextileEditorButton("ed_ul", "/assets/textile-editor/list_bullets.png", " * ", "\n", ".", "Bulleted List"), new TextileEditorButton("ed_p", "/assets/textile-editor/paragraph.png", "p", "\n", "p", "Paragraph"), new TextileEditorButton("ed_h1", "/assets/textile-editor/h1.png", "h1", "\n", "1", "Header 1"), new TextileEditorButton("ed_h2", "/assets/textile-editor/h2.png", "h2", "\n", "2", "Header 2"), new TextileEditorButton("ed_h3", "/assets/textile-editor/h3.png", "h3", "\n", "3", "Header 3"), new TextileEditorButton("ed_h4", "/assets/textile-editor/h4.png", "h4", "\n", "4", "Header 4"), new TextileEditorButton("ed_block", "/assets/textile-editor/blockquote.png", "bq", "\n", "q", "Blockquote"), new TextileEditorButton("ed_outdent", "/assets/textile-editor/outdent.png", ")", "\n", "]", "Outdent"), new TextileEditorButton("ed_indent", "/assets/textile-editor/indent.png", "(", "\n", "[", "Indent"), new TextileEditorButton("ed_justifyl", "/assets/textile-editor/left.png", "<", "\n", "l", "Left Justify"), new TextileEditorButton("ed_justifyc", "/assets/textile-editor/center.png", "=", "\n", "e", "Center Text"), new TextileEditorButton("ed_justifyr", "/assets/textile-editor/right.png", ">", "\n", "r", "Right Justify"), new TextileEditorButton("ed_justify", "/assets/textile-editor/justify.png", "<>", "\n", "j", "Justify"), new TextileEditorButton("ed_code", "code", "@", "@", "c", "Code")]);
...
(function() {
  jQuery(function() {
    return $("#show-update").click(function() {
      $("#show").toggle();
